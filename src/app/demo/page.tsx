        ...
        <div className="w-full max-w-7xl mx-auto mt-16 mb-32">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-foreground/70 max-w-3xl mx-auto">
              <EnhancedTextEffect
                words="Experience how DesignSystem.io helps you build and manage your design system with premium components."
                duration={0.2}
                variant="reveal"
                textSize="xl"
                threshold={0.1}
          ...
          >
            ...
            <div className="bg-neutral-950 p-4 border-b border-neutral-800 flex items-center">
              ...
              <div className="flex-1 text-center text-sm font-medium text-neutral-400">DesignSystem.io - Demo</div>
            </div>
