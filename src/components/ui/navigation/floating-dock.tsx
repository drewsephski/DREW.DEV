  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div className="flex items-center justify-center p-2 bg-black/40 backdrop-blur-lg rounded-full border border-white/10 shadow-lg">
...
// Blog dock items
export const blogDockItems: FloatingDockItem[] = [
  {
    name: 'Home',
    href: '/',
    icon: (
